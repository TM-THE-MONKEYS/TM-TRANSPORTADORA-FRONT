...
import { mockLogin, mockMe, mockForgotPassword, mockResetPassword, mockChangePassword } from "@/lib/mocks/auth"

export { mockLogin, mockMe, mockForgotPassword, mockResetPassword, mockChangePassword }
...
export async function mockAddOccurrence(
  ...
  const { mockTrackingUpdates } = await import("@/lib/mocks/tracking-data")
